    ...
    <div class="container-fluid py-4">
        <div class="row mt-4">
            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 m-auto">
                ...
                <form action="<?= base_url('loginback') ?>" method="post">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-5">
                            ...
                            <div class="form-group pt-5 d-flex justify-content-between align-items-center">
                                ...
                                <p class="d-flex justify-content-between align-items-center m-0"> Not have an account? <a href="<?= base_url('registerback') ?>" class="nav-link"> Register </a> </p>
                            </div>
                        </div>
                    </div>
                </form>
